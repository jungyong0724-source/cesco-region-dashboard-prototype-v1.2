...
// ─── 업종 목록 (업종 빠른탭 — KSIC 정합 재설계 8종, 2026-09-21 v0.4) ──
// KSIC 코드 실측 검증 완료(cesnet2.cesco.biz:19008). 주점 복원, 제과점 코드 정정(I56191→G47216).
// 식품제조(C10)·축산물가공(C1012)은 기간 제한 유무와 무관하게 하위 코드 전부 포함해도 실측 0건이
// 재확정되어(대체 코드 G4713도 면세점만 매칭돼 대안 없음) 최종 제외.
// 각 탭의 KSIC 매핑·실측 건수는 `기획/업종매핑표_초안_v0.1.md`(v0.4) 참조.
const INDUSTRY_TAB_LIST = [
  '음식점',      // KSIC I561 (한식/외국식/간이음식점 등) — 실측 81,771건
  '카페·음료',   // KSIC I5622 (커피전문점 등) — 실측 18,340건
  '주점',        // KSIC I5621 (생맥주전문점/유흥주점 등) — 실측 15,362건, v0.2 보류에서 복원
  '숙박',        // KSIC I55 — 실측 4,180건
  '의료기관',    // KSIC Q86 (의원·한의원·치과 등) — 실측 4,403건
  '제과점',      // KSIC G47216(빵류·과자류 소매) — I56191은 0건이라 정정, 실측 6,607건
  '소매업',      // KSIC G47 — 실측 90,994건
  '기타서비스'   // KSIC S96 등 — 실측 36,009건
];
...
const ALL_CUSTOMERS = [
  ...
  },
  {
    ...
    employees: '3 명',
    homepage: '-',
    email: 'itaewon.roastery@daum.net',
    lat: 37.53163,
    lng: 126.99482,
    branch: '서울동부지사',
    clcBranch: '서울중앙지국',
